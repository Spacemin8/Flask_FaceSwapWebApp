...
def homepage():
    ...
    if(form.is_submitted()):
        ...
        lmarkpic=  url_for('static', filename=f"output/{img3}")
        return render_template('main.html', form=form, mfp=mfacepic, sfp=sfacepic, ofp=ofacepic, afp=lmarkpic, fn=outpath.split(".")[0])
    return render_template('main.html', form=form)
